...
class TestBoundaryDestinasiWisata(unittest.TestCase):
    ...
    def test_getList(self):
        BoundaryDestinasiWisata.addToDestinasiPilihan(self, DestinasiWisata(1, "Dufan", "1", "Tempat bermain anak"))
        self.assertEqual(len(BoundaryDestinasiWisata.getList(self)), 1) 
        
    def test_addToDestinasiPilihan(self):
        BoundaryDestinasiWisata.addToDestinasiPilihan(self, DestinasiWisata(1, "Dufan", "1", "Tempat bermain anak"))
        BoundaryDestinasiWisata.addToDestinasiPilihan(self, DestinasiWisata(2, "Pantai Ancol", "1", "Tempat pantai anak"))
